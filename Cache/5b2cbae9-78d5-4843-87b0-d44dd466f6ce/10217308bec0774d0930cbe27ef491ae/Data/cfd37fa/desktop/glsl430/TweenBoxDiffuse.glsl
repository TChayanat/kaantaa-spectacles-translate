...
//sampler sampler z_hitIdAndBarycentricSmp 0:44
//sampler sampler z_rayDirectionsSmpSC 0:45
//texture texture2D baseTex 0:3:0:28
//texture texture2D detailNormalTex 0:4:0:29
//texture texture2D intensityTexture 0:5:0:30
//texture texture2D normalTex 0:6:0:31
//texture texture2D opacityTex 0:7:0:32
//texture texture2D sc_EnvmapDiffuse 0:8:0:33
//texture texture2D sc_EnvmapSpecular 0:9:0:34
//texture texture2D sc_OITAlpha0 0:10:0:35
//texture texture2D sc_OITAlpha1 0:11:0:35
//texture texture2D sc_OITDepthHigh0 0:12:0:35
//texture texture2D sc_OITDepthHigh1 0:13:0:35
//texture texture2D sc_OITDepthLow0 0:14:0:35
//texture texture2D sc_OITDepthLow1 0:15:0:35
//texture texture2D sc_OITFilteredDepthBoundsTexture 0:16:0:35
//texture texture2D sc_OITFrontDepthTexture 0:17:0:35
...
//texture utexture2D z_hitIdAndBarycentric 0:26:0:44
//texture texture2D z_rayDirections 0:27:0:45
//texture texture2DArray baseTexArrSC 0:46:0:28
//texture texture2DArray detailNormalTexArrSC 0:47:0:29
//texture texture2DArray intensityTextureArrSC 0:48:0:30
//texture texture2DArray normalTexArrSC 0:49:0:31
//texture texture2DArray opacityTexArrSC 0:50:0:32
//texture texture2DArray sc_EnvmapDiffuseArrSC 0:51:0:33
//texture texture2DArray sc_EnvmapSpecularArrSC 0:52:0:34
//texture texture2DArray sc_RayTracedAoTextureArrSC 0:53:0:36
//texture texture2DArray sc_RayTracedDiffIndTextureArrSC 0:54:0:37
//texture texture2DArray sc_RayTracedShadowTextureArrSC 0:56:0:39
//texture texture2DArray sc_ScreenTextureArrSC 0:57:0:41
...
{
float l9_20=l9_13.x;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_21=l9_20;
float l9_22=l9_13.y;
sc_SoftwareWrapEarly(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_23=l9_22;
vec2 l9_24;
float l9_25;
...
{
l9_26=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_26=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_27=l9_21;
float l9_28=1.0;
sc_ClampUV(l9_27,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_26,l9_28);
float l9_29=l9_27;
float l9_30=l9_28;
bool l9_31;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_31=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_31=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_32=l9_23;
float l9_33=l9_30;
sc_ClampUV(l9_32,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_31,l9_33);
l9_25=l9_33;
...
#endif
vec2 l9_34=sc_TransformUV(l9_24,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_35=l9_34.x;
float l9_36=l9_25;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_36);
float l9_37=l9_34.y;
float l9_38=l9_36;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_38);
float l9_39=l9_38;
vec3 l9_40=sc_SamplingCoordsViewToGlobal(vec2(l9_35,l9_37),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_41=texture(opacityTexArrSC,l9_40,0.0);
vec4 l9_42;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_42=mix(opacityTexBorderColor,l9_41,vec4(l9_39));
}
#else
{
l9_42=l9_41;
...
float l9_58=l9_57.x;
float l9_59=l9_48;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_59);
float l9_60=l9_57.y;
float l9_61=l9_59;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_61);
float l9_62=l9_61;
...
#endif
float l9_67=(baseColor*l9_11).w*l9_12;
...
{
vec2 l9_72;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_72,l9_8);
l9_71=l9_72;
}
#else
{
...
{
vec2 l9_74;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_74,l9_8);
l9_73=l9_74;
}
#else
{
l9_73=varPackedTex.xy;
}
#endif
l9_71=l9_73;
}
...
{
float l9_75=l9_69.x;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_76=l9_75;
float l9_77=l9_69.y;
sc_SoftwareWrapEarly(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_78=l9_77;
vec2 l9_79;
float l9_80;
...
{
l9_81=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_81=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_82=l9_76;
float l9_83=1.0;
sc_ClampUV(l9_82,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_81,l9_83);
float l9_84=l9_82;
float l9_85=l9_83;
bool l9_86;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_86=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_86=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_87=l9_78;
float l9_88=l9_85;
sc_ClampUV(l9_87,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_86,l9_88);
l9_80=l9_88;
...
#endif
vec2 l9_89=sc_TransformUV(l9_79,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_90=l9_89.x;
float l9_91=l9_80;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_91);
float l9_92=l9_89.y;
float l9_93=l9_91;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_93);
}
#else
{
float l9_94=l9_69.x;
sc_SoftwareWrapEarly(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_95=l9_94;
float l9_96=l9_69.y;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_97=l9_96;
vec2 l9_98;
float l9_99;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
...
float l9_101=l9_95;
float l9_102=1.0;
sc_ClampUV(l9_101,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_100,l9_102);
float l9_103=l9_101;
float l9_104=l9_102;
bool l9_105;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_105=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_105=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_106=l9_97;
float l9_107=l9_104;
sc_ClampUV(l9_106,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_105,l9_107);
l9_99=l9_107;
...
#endif
vec2 l9_108=sc_TransformUV(l9_98,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_109=l9_108.x;
float l9_110=l9_99;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_110);
float l9_111=l9_108.y;
float l9_112=l9_110;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_112);
}
#endif
...
{
vec2 l9_116;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_116,l9_8);
l9_115=l9_116;
}
#else
{
...
{
vec2 l9_118;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_118,l9_8);
l9_117=l9_118;
}
#else
{
l9_117=varPackedTex.xy;
}
#endif
l9_115=l9_117;
}
...
{
float l9_119=l9_113.x;
sc_SoftwareWrapEarly(l9_119,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_120=l9_119;
float l9_121=l9_113.y;
sc_SoftwareWrapEarly(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_122=l9_121;
vec2 l9_123;
float l9_124;
...
{
l9_125=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_125=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_126=l9_120;
float l9_127=1.0;
sc_ClampUV(l9_126,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_125,l9_127);
float l9_128=l9_126;
float l9_129=l9_127;
bool l9_130;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_130=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_130=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_131=l9_122;
float l9_132=l9_129;
sc_ClampUV(l9_131,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_130,l9_132);
l9_124=l9_132;
l9_123=vec2(l9_128,l9_131);
}
#else
{
l9_124=1.0;
l9_123=vec2(l9_120,l9_122);
}
#endif
vec2 l9_133=sc_TransformUV(l9_123,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_134=l9_133.x;
float l9_135=l9_124;
sc_SoftwareWrapLate(l9_134,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_135);
float l9_136=l9_133.y;
float l9_137=l9_135;
sc_SoftwareWrapLate(l9_136,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_137);
}
#else
{
float l9_138=l9_113.x;
sc_SoftwareWrapEarly(l9_138,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_139=l9_138;
float l9_140=l9_113.y;
sc_SoftwareWrapEarly(l9_140,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_141=l9_140;
vec2 l9_142;
float l9_143;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_144=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_144=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_145=l9_139;
float l9_146=1.0;
sc_ClampUV(l9_145,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_144,l9_146);
float l9_147=l9_145;
float l9_148=l9_146;
bool l9_149;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_149=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_149=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_150=l9_141;
float l9_151=l9_148;
sc_ClampUV(l9_150,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_149,l9_151);
l9_143=l9_151;
...
#endif
vec2 l9_152=sc_TransformUV(l9_142,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_153=l9_152.x;
float l9_154=l9_143;
sc_SoftwareWrapLate(l9_153,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_154);
float l9_155=l9_152.y;
float l9_156=l9_154;
sc_SoftwareWrapLate(l9_155,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_156);
}
#endif
}
#else
...
#endif
float l9_157=clamp(l9_68,0.0,1.0);
...
{
l9_68=texture(sc_RayTracedShadowTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_66,sc_RayTracedShadowTextureLayout,l9_67),0.0);
}
#else
{
l9_68=texture(sc_RayTracedShadowTexture,sc_SamplingCoordsViewToGlobal(l9_66,sc_RayTracedShadowTextureLayout,l9_67).xy,0.0);
}
#endif
...
#if (ENABLE_NORMALMAP)
{
mat3 l9_83=mat3(l9_5,l9_3,l9_4);
vec2 l9_84;
#if (NODE_181_DROPLIST_ITEM==0)
{
l9_84=l9_8;
...
{
vec2 l9_87;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_87,l9_20);
l9_86=l9_87;
}
#else
{
...
{
vec2 l9_89;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_89,l9_20);
l9_88=l9_89;
}
#else
{
...
{
float l9_91=l9_84.x;
sc_SoftwareWrapEarly(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_92=l9_91;
float l9_93=l9_84.y;
sc_SoftwareWrapEarly(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_94=l9_93;
vec2 l9_95;
float l9_96;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_97=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_97=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_98=l9_92;
float l9_99=1.0;
sc_ClampUV(l9_98,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_97,l9_99);
float l9_100=l9_98;
float l9_101=l9_99;
bool l9_102;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_102=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_102=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_103=l9_94;
float l9_104=l9_101;
sc_ClampUV(l9_103,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_102,l9_104);
l9_96=l9_104;
...
#endif
vec2 l9_105=sc_TransformUV(l9_95,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_106=l9_105.x;
float l9_107=l9_96;
sc_SoftwareWrapLate(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_107);
float l9_108=l9_105.y;
float l9_109=l9_107;
sc_SoftwareWrapLate(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_109);
float l9_110=l9_109;
vec3 l9_111=sc_SamplingCoordsViewToGlobal(vec2(l9_106,l9_108),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_112=texture(normalTexArrSC,l9_111,0.0);
vec4 l9_113;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_113=mix(normalTexBorderColor,l9_112,vec4(l9_110));
}
#else
{
l9_113=l9_112;
...
float l9_130=l9_119;
sc_SoftwareWrapLate(l9_129,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_130);
float l9_131=l9_128.y;
float l9_132=l9_130;
sc_SoftwareWrapLate(l9_131,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_132);
float l9_133=l9_132;
vec3 l9_134=sc_SamplingCoordsViewToGlobal(vec2(l9_129,l9_131),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_135=texture(normalTex,l9_134.xy,0.0);
vec4 l9_136;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
...
{
vec2 l9_141;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_141,l9_20);
l9_140=l9_141;
}
#else
{
...
{
vec2 l9_143;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_143,l9_20);
l9_142=l9_143;
}
#else
{
...
#if (detailNormalTexLayout==2)
{
float l9_145=l9_138.x;
sc_SoftwareWrapEarly(l9_145,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_146=l9_145;
float l9_147=l9_138.y;
sc_SoftwareWrapEarly(l9_147,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_148=l9_147;
vec2 l9_149;
float l9_150;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_151=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_151=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_152=l9_146;
float l9_153=1.0;
sc_ClampUV(l9_152,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_151,l9_153);
float l9_154=l9_152;
float l9_155=l9_153;
bool l9_156;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_156=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_156=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_157=l9_148;
float l9_158=l9_155;
sc_ClampUV(l9_157,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_156,l9_158);
l9_150=l9_158;
l9_149=vec2(l9_154,l9_157);
}
#else
{
l9_150=1.0;
l9_149=vec2(l9_146,l9_148);
}
#endif
vec2 l9_159=sc_TransformUV(l9_149,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_160=l9_159.x;
float l9_161=l9_150;
sc_SoftwareWrapLate(l9_160,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_161);
float l9_162=l9_159.y;
float l9_163=l9_161;
sc_SoftwareWrapLate(l9_162,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_163);
float l9_164=l9_163;
vec3 l9_165=sc_SamplingCoordsViewToGlobal(vec2(l9_160,l9_162),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_166=texture(detailNormalTexArrSC,l9_165,0.0);
vec4 l9_167;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_167=mix(detailNormalTexBorderColor,l9_166,vec4(l9_164));
}
#else
{
l9_167=l9_166;
...
#else
{
float l9_168=l9_138.x;
sc_SoftwareWrapEarly(l9_168,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_169=l9_168;
float l9_170=l9_138.y;
sc_SoftwareWrapEarly(l9_170,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_171=l9_170;
vec2 l9_172;
float l9_173;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_174=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_174=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_175=l9_169;
float l9_176=1.0;
sc_ClampUV(l9_175,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_174,l9_176);
float l9_177=l9_175;
float l9_178=l9_176;
bool l9_179;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_179=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_179=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_180=l9_171;
float l9_181=l9_178;
sc_ClampUV(l9_180,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_179,l9_181);
l9_173=l9_181;
l9_172=vec2(l9_177,l9_180);
}
#else
{
l9_173=1.0;
l9_172=vec2(l9_169,l9_171);
}
#endif
vec2 l9_182=sc_TransformUV(l9_172,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_183=l9_182.x;
float l9_184=l9_173;
sc_SoftwareWrapLate(l9_183,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_184);
float l9_185=l9_182.y;
float l9_186=l9_184;
sc_SoftwareWrapLate(l9_185,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0)),l9_186);
float l9_187=l9_186;
vec3 l9_188=sc_SamplingCoordsViewToGlobal(vec2(l9_183,l9_185),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_189=texture(detailNormalTex,l9_188.xy,0.0);
vec4 l9_190;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_190=mix(detailNormalTexBorderColor,l9_189,vec4(l9_187));
}
#else
{
l9_190=l9_189;
...
#endif
l9_137=((l9_144.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_137=Port_Default_N113;
}
#endif
vec3 l9_191=mix(vec3(0.0,0.0,1.0),((l9_90.xyz*1.9921875)-vec3(1.0)).xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
vec3 l9_192=mix(vec3(0.0,0.0,1.0),l9_137,vec3(Port_Strength2_N200));
vec3 l9_193=l9_192*vec3(-1.0,-1.0,1.0);
vec3 l9_194=l9_83*normalize((l9_191*dot(l9_191,l9_193))-(l9_193*l9_191.z));
...
#else
{
float l9_197=dot(l9_4,l9_4);
float l9_198;
if (l9_197>0.0)
{
l9_198=1.0/sqrt(l9_197);
}
else
{
l9_198=0.0;
...
#endif
float l9_200=clamp(l9_81,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_200<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_200<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_201=max(l9_21.xyz,vec3(0.0));
vec4 l9_202;
#if (sc_ProjectiveShadowsCaster)
{
l9_202=vec4(l9_201,l9_200);
}
#else
{
l9_202=ngsCalculateLighting(l9_201,l9_200,l9_199,l9_10,l9_11,Port_Emissive_N036,0.0,1.0,Port_AO_N036,vec3(1.0));
}
#endif
vec4 l9_203=max(l9_202,vec4(0.0));
if (isProxyMode)
{
vec4 l9_204;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0(max(l9_204,vec4(0.0)));
return;
}
vec4 l9_206;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_208=clamp(l9_203.w*2.0,0.0,1.0);
}
#else
{
float l9_209;
...
{
l9_209=clamp(dot(l9_203.xyz,vec3(l9_203.w)),0.0,1.0);
}
#else
{
float l9_210;
...
#if (sc_BlendMode_Multiply)
{
l9_211=(1.0-dot(l9_203.xyz,vec3(0.33333001)))*l9_203.w;
}
#else
{
float l9_212;
...
{
l9_212=(1.0-clamp(dot(l9_203.xyz,vec3(1.0)),0.0,1.0))*l9_203.w;
}
#else
{
float l9_213;
#if (sc_BlendMode_ColoredGlass)
{
l9_213=clamp(dot(l9_203.xyz,vec3(1.0)),0.0,1.0)*l9_203.w;
}
#else
{
float l9_214;
#if (sc_BlendMode_Add)
{
l9_214=clamp(dot(l9_203.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_215;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_215=clamp(dot(l9_203.xyz,vec3(1.0)),0.0,1.0)*l9_203.w;
}
#else
{
float l9_216;
...
{
l9_216=dot(l9_203.xyz,vec3(0.33333001))*l9_203.w;
}
#else
{
float l9_217;
#if (sc_BlendMode_Min)
{
l9_217=1.0-clamp(dot(l9_203.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_218;
#if (sc_BlendMode_Max)
{
l9_218=clamp(dot(l9_203.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_218=1.0;
...
#endif
l9_206=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_203.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_207);
}
#else
{
vec4 l9_219;
...
{
vec3 l9_221=sc_GetFramebufferColor().xyz;
vec3 l9_222=mix(l9_221,definedBlend(l9_221,l9_203.xyz).xyz,vec3(l9_203.w));
vec4 l9_223=vec4(l9_222.x,l9_222.y,l9_222.z,vec4(0.0).w);
l9_223.w=1.0;
l9_220=l9_223;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_225=l9_203.w;
l9_224=vec4(mix(vec3(1.0),l9_203.xyz,vec3(l9_225)),l9_225);
}
#else
{
vec4 l9_226;
...
{
float l9_227=l9_203.w;
float l9_228;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_228=clamp(l9_227,0.0,1.0);
}
#else
{
l9_228=l9_227;
...
#endif
l9_226=vec4(l9_203.xyz*l9_228,l9_228);
}
#else
{
l9_226=l9_203;
...
{
l9_231=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_231=vec4(0.0);
...
vec4 l9_233=outputMotionVectorsIfNeeded(varPos,max(l9_232,vec4(0.0)));
vec4 l9_234=clamp(l9_233,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_235=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_235-0.0039215689)),min(1.0,l9_235+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_236=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_236).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_237=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_236).xy);
float l9_238=packValue(l9_237);
int l9_245=int(l9_234.w*255.0);
float l9_246=packValue(l9_245);
sc_writeFragData0(vec4(packValue(l9_237),packValue(l9_237),packValue(l9_237),packValue(l9_237)));
sc_writeFragData1(vec4(l9_238,packValue(l9_237),packValue(l9_237),packValue(l9_237)));
sc_writeFragData2(vec4(l9_246,packValue(l9_245),packValue(l9_245),packValue(l9_245)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_249).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_254==0)
{
l9_257=texture(sc_OITAlpha0,l9_249);
l9_256=texture(sc_OITDepthLow0,l9_249);
l9_255=texture(sc_OITDepthHigh0,l9_249);
}
else
{
l9_257=vec4(0.0);
...
if (l9_254==1)
{
l9_260=texture(sc_OITAlpha1,l9_249);
l9_259=texture(sc_OITDepthLow1,l9_249);
l9_258=texture(sc_OITDepthHigh1,l9_249);
}
else
{
l9_260=l9_257;
...
if (any(notEqual(l9_258,vec4(0.0)))||any(notEqual(l9_259,vec4(0.0))))
{
int l9_261[8]=l9_250;
unpackValues(l9_258.w,l9_254,l9_261);
unpackValues(l9_258.z,l9_254,l9_261);
unpackValues(l9_258.y,l9_254,l9_261);
unpackValues(l9_258.x,l9_254,l9_261);
unpackValues(l9_259.w,l9_254,l9_261);
unpackValues(l9_259.z,l9_254,l9_261);
unpackValues(l9_259.y,l9_254,l9_261);
unpackValues(l9_259.x,l9_254,l9_261);
int l9_270[8]=l9_251;
unpackValues(l9_260.w,l9_254,l9_270);
unpackValues(l9_260.z,l9_254,l9_270);
unpackValues(l9_260.y,l9_254,l9_270);
unpackValues(l9_260.x,l9_254,l9_270);
}
l9_254++;
continue;
}
...
vec4 l9_275=texture(sc_OITFilteredDepthBoundsTexture,l9_249);
vec2 l9_276=l9_275.xy;
int l9_277;
#if (sc_SkinBonesCount>0)
{
l9_277=encodeDepth(((1.0-l9_275.x)*1000.0)+getDepthOrderingEpsilon(),l9_276);
}
#else
{
l9_277=0;
...
#endif
int l9_278=encodeDepth(viewSpaceDepth(),l9_276);
vec4 l9_279;
l9_279=l9_234*l9_234.w;
vec4 l9_280;
int l9_281=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_281<8)
{
int l9_282=l9_250[l9_281];
int l9_283=l9_278-l9_277;
bool l9_284=l9_282<l9_283;
bool l9_285;
if (l9_284)
{
l9_285=l9_250[l9_281]>0;
}
else
{
l9_285=l9_284;
...
if (l9_285)
{
vec3 l9_286=l9_279.xyz*(1.0-(float(l9_251[l9_281])/255.0));
l9_280=vec4(l9_286.x,l9_286.y,l9_286.z,l9_279.w);
}
else
{
l9_280=l9_279;

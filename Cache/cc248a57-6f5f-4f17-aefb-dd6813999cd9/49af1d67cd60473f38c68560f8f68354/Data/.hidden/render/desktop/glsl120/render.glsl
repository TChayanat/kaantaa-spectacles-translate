...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,gParticle.Dead,l9_4,fract(abs(((l9_2*0.000651354)+0.151235)+(floor(((l9_5-l9_4)+12.0)*0.166667)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))*vec2(0.00250627),0.0,l9_0,(l9_2+0.5)*0.000666667,l9_2*0.000667111,l9_1,(l9_3+vec2(0.5))*vec2(0.00293255,0.2),l9_3*vec2(0.00294118,0.25),vec3(0.0),false);
...
vec3 l9_11=gParticle.Matrix*vec3(1.0,0.0,0.0);
varTangent=vec4(l9_11.x,l9_11.y,l9_11.z,varTangent.w);
varTangent.w=1.0;
varPackedTex=vec4(l9_2,l9_3);
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
vec4 l9_12=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
varViewSpaceDepth=-l9_12.z;
sc_SetClipPosition(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_12);
}
#else
{
...
float l9_15=l9_13.w;
vec4 l9_16=l9_13;
l9_16.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_15))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_15;
l9_14=l9_16;
}
#else
{
...
float l9_72=pow(l9_71,1.0/correctedIntensity);
int l9_73;
...
#endif
float l9_74=l9_72;
sc_SoftwareWrapEarly(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).x);
float l9_75=l9_74;
vec2 l9_76=vec2(l9_72,0.5);
l9_76.x=l9_75;
float l9_77=0.5;
...
{
l9_82=ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).x==3;
}
#else
{
l9_82=(int(SC_USE_CLAMP_TO_BORDER_intensityTexture)!=0);
}
#endif
float l9_83=l9_75;
float l9_84=1.0;
sc_ClampUV(l9_83,intensityTextureUvMinMax.x,intensityTextureUvMinMax.z,l9_82,l9_84);
vec2 l9_85=l9_79;
l9_85.x=l9_83;
float l9_86=l9_84;
bool l9_87;
#if (SC_USE_CLAMP_TO_BORDER_intensityTexture)
{
l9_87=ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).y==3;
}
#else
{
l9_87=(int(SC_USE_CLAMP_TO_BORDER_intensityTexture)!=0);
}
#endif
float l9_88=l9_78;
float l9_89=l9_86;
sc_ClampUV(l9_88,intensityTextureUvMinMax.y,intensityTextureUvMinMax.w,l9_87,l9_89);
vec2 l9_90=l9_85;
l9_90.y=l9_88;
l9_81=l9_89;
l9_80=l9_90;
...
#endif
vec2 l9_91=sc_TransformUV(l9_80,(int(SC_USE_UV_TRANSFORM_intensityTexture)!=0),intensityTextureTransform);
float l9_92=l9_91.x;
float l9_93=l9_81;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).x,(int(SC_USE_CLAMP_TO_BORDER_intensityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_intensityTexture)!=0)),l9_93);
vec2 l9_94=l9_91;
l9_94.x=l9_92;
float l9_95=l9_91.y;
float l9_96=l9_93;
sc_SoftwareWrapLate(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).y,(int(SC_USE_CLAMP_TO_BORDER_intensityTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_intensityTexture)!=0)),l9_96);
vec2 l9_97=l9_94;
l9_97.y=l9_95;
float l9_98=l9_96;
vec4 l9_99=sc_SampleView(intensityTextureDims.xy,l9_97,intensityTextureLayout,l9_73,0.0,intensityTexture);
vec4 l9_100;
#if (SC_USE_CLAMP_TO_BORDER_intensityTexture)
{
l9_100=mix(intensityTextureBorderColor,l9_99,vec4(l9_98));
}
#else
{
l9_100=l9_99;
...
#endif
float l9_101=(((l9_100.x*256.0)+l9_100.y)+(l9_100.z*0.00390625))*0.0622559;
float l9_102;
#if (BLEND_MODE_FORGRAY)
{
l9_102=max(l9_101,1.0);
}
#else
{
l9_102=l9_101;
...
{
vec3 l9_105=vec3(0.0);
l9_105.x=l9_70.x;
vec3 l9_106=l9_105;
l9_106.y=l9_70.y;
vec3 l9_107=l9_106;
l9_107.z=RGBToHSL(l9_69).z;
l9_104=HSLToRGB(l9_107);
}
#else
{
vec3 l9_108=vec3(0.0);
l9_108.x=transformSingleColor(l9_71,l9_103,l9_70.x);
vec3 l9_109=l9_108;
l9_109.y=transformSingleColor(l9_71,l9_103,l9_70.y);
vec3 l9_110=l9_109;
l9_110.z=transformSingleColor(l9_71,l9_103,l9_70.z);
l9_104=clamp(l9_110,vec3(0.0),vec3(1.0));
}
#endif
l9_68=l9_104;
}
...
vec2 l9_8=l9_7-Port_Center_N012;
vec2 l9_9=(((l9_8*(vec2(Port_Input0_N011)/(clamp(Port_Import_N091,vec2(0.0),vec2(10.0))+vec2(1.234e-06))))+Port_Center_N012)*vec2(Port_Input1_N013))-vec2(Port_Input1_N014);
float l9_10=atan(l9_9.y*Port_Input1_N017,l9_9.x);
float l9_11=floor(mod(float(Interp_Particle_Index),Port_Input1_N057));
float l9_12;
if (l9_11==0.0)
{
l9_12=Port_Value0_N055;
}
else
{
float l9_13;
...
if (l9_11==2.0)
{
l9_14=Port_Value2_N055;
}
else
{
l9_14=Port_Default_N055;
}
l9_13=l9_14;
}
l9_12=l9_13;
}
float l9_15=(Port_Input0_N023*3.14159)/(clamp(floor(l9_12),Port_Input1_N027,Port_Input2_N027)+1.234e-06);
if (float((((((1.0-(cos((floor((l9_10/(l9_15+1.234e-06))+Port_Input1_N030)*l9_15)-l9_10)*length(l9_9)))-Port_RangeMinA_N053)/(clamp(Port_Import_N003,0.0,1.0)-Port_RangeMinA_N053))*(Port_RangeMaxB_N053-Port_RangeMinB_N053))+Port_RangeMinB_N053)<Port_Input1_N054)!=0.0)
{
discard;
}
vec4 l9_16=ngsPixelShader(Interp_Particle_Color);
vec4 l9_17;
#if (sc_ShaderComplexityAnalyzer)
{
l9_17=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_17=vec4(0.0);
...
vec4 l9_19=clamp(l9_18,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_20=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_20),min(1.0,l9_20+0.00392157),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_21).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_22=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_21).xy);
float l9_23=packValue(l9_22);
vec4 l9_24=vec4(0.0);
l9_24.x=l9_23;
vec4 l9_26=l9_24;
l9_26.y=packValue(l9_22);
vec4 l9_28=l9_26;
l9_28.z=packValue(l9_22);
vec4 l9_30=l9_28;
l9_30.w=packValue(l9_22);
vec4 l9_32=vec4(0.0);
l9_32.x=packValue(l9_22);
vec4 l9_34=l9_32;
l9_34.y=packValue(l9_22);
vec4 l9_36=l9_34;
l9_36.z=packValue(l9_22);
vec4 l9_37=l9_36;
l9_37.w=packValue(l9_22);
int l9_38=int(l9_19.w*255.0);
...
vec4 l9_45=l9_44;
l9_45.w=packValue(l9_38);
sc_writeFragData0(l9_37);
sc_writeFragData1(l9_30);
sc_writeFragData2(l9_45);
...
if (l9_57==0)
{
l9_60=texture2D(sc_OITAlpha0,l9_46);
l9_59=texture2D(sc_OITDepthLow0,l9_46);
l9_58=texture2D(sc_OITDepthHigh0,l9_46);
}
else
{
l9_60=l9_53;
...
if (l9_57==1)
{
l9_56=texture2D(sc_OITAlpha1,l9_46);
l9_55=texture2D(sc_OITDepthLow1,l9_46);
l9_54=texture2D(sc_OITDepthHigh1,l9_46);
}
else
{
l9_56=l9_60;
...
{
int l9_61[8]=l9_47;
unpackValues(l9_54.w,l9_57,l9_61);
unpackValues(l9_54.z,l9_57,l9_61);
unpackValues(l9_54.y,l9_57,l9_61);
unpackValues(l9_54.x,l9_57,l9_61);
unpackValues(l9_55.w,l9_57,l9_61);
unpackValues(l9_55.z,l9_57,l9_61);
unpackValues(l9_55.y,l9_57,l9_61);
unpackValues(l9_55.x,l9_57,l9_61);
int l9_70[8]=l9_48;
unpackValues(l9_56.w,l9_57,l9_70);
unpackValues(l9_56.z,l9_57,l9_70);
unpackValues(l9_56.y,l9_57,l9_70);
unpackValues(l9_56.x,l9_57,l9_70);
}
l9_53=l9_56;
l9_52=l9_55;
l9_51=l9_54;
...
vec4 l9_75=texture2D(sc_OITFilteredDepthBoundsTexture,l9_46);
vec2 l9_76=l9_75.xy;
int l9_77;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_77=encodeDepth(((1.0-l9_75.x)*1000.0)+l9_78,l9_76);
}
#else
{
l9_77=0;
...
#endif
int l9_79=encodeDepth(viewSpaceDepth(),l9_76);
vec4 l9_80;
l9_80=l9_19*l9_19.w;
vec4 l9_81;
int l9_82=0;
...
if (l9_82<8)
{
int l9_83=l9_47[l9_82];
int l9_84=l9_79-l9_77;
...
if (l9_86)
{
vec3 l9_87=l9_80.xyz*(1.0-(float(l9_48[l9_82])*0.00392157));

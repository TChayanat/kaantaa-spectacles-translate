...
uniform vec2 Port_Import_N091;
uniform vec2 Port_Center_N012;
uniform float Port_Input1_N013;
uniform float Port_Input1_N014;
uniform float Port_Input1_N017;
uniform float Port_Input0_N023;
uniform float Port_Input1_N057;
uniform float Port_Value0_N055;
uniform float Port_Value1_N055;
uniform float Port_Value2_N055;
uniform float Port_Default_N055;
uniform float Port_Import_N024;
uniform float Port_Input1_N027;
uniform float Port_Input2_N027;
...
ivec2 l9_3=ivec2(l9_0%512,l9_0/512);
float l9_4=float(l9_0);
vec2 l9_5=vec2(l9_3);
float l9_6=l9_4/1499.0;
float l9_7=floor(l9_2/500.0)*2.0;
float l9_8;
...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,gParticle.SpawnIndex,gParticle.SpawnIndexRemainder,gParticle.NextBurstTime,l9_7,fract(abs(((l9_6*0.97637898)+0.151235)+(floor(((((l9_8-l9_7)-0.0)+0.0)+12.0)/6.0)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))/vec2(399.0),0.0,l9_0,l9_1,l9_2,(1500*((l9_0/1500)+1))-1,(l9_4+0.5)/1500.0,l9_6,l9_2/1499.0,l9_3,(l9_5+vec2(0.5))/vec2(512.0,3.0),l9_5/vec2(511.0,2.0),vec3(0.0),false,gParticle.CopyId,gParticle.SpawnAmount,gParticle.BurstAmount,gParticle.BurstPeriod);
int l9_9=InstanceID;
int l9_10=(vfxOffsetInstancesRead+l9_9)*4;
int l9_11=l9_10/vfxTargetWidth;
vec2 l9_12=(vec2(ivec2(l9_10-(l9_11*vfxTargetWidth),l9_11))+vec2(0.5))/vec2(2048.0,vfxTargetSizeRead.y);
vec2 l9_13=l9_12+vec2(0.0);
vec4 l9_14=renderTarget0SampleViewIndexBias(l9_13,renderTarget0GetStereoViewIndex(),0.0);
bool l9_15=dot(abs(l9_14),vec4(1.0))<9.9999997e-06;
bool l9_16;
if (!l9_15)
{
l9_16=!vfxBatchEnable[sc_GetLocalInstanceID()/1500];
}
else
{
l9_16=l9_15;
...
gParticle.Position.y=(-1000.0)+(((DecodeFloat32(renderTarget1SampleViewIndexBias(l9_13,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*(1000.0-(-1000.0)))/(0.99998999-0.0));
gParticle.Position.z=(-1000.0)+(((DecodeFloat32(renderTarget2SampleViewIndexBias(l9_13,renderTarget2GetStereoViewIndex(),0.0),true)-0.0)*(1000.0-(-1000.0)))/(0.99998999-0.0));
gParticle.Velocity.x=(-1000.0)+(((DecodeFloat32(renderTarget3SampleViewIndexBias(l9_13,renderTarget3GetStereoViewIndex(),0.0),true)-0.0)*(1000.0-(-1000.0)))/(0.99998999-0.0));
vec2 l9_17=l9_12+vec2(0.00048828125,0.0);
gParticle.Velocity.y=(-1000.0)+(((DecodeFloat32(renderTarget0SampleViewIndexBias(l9_17,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*(1000.0-(-1000.0)))/(0.99998999-0.0));
gParticle.Velocity.z=(-1000.0)+(((DecodeFloat32(renderTarget1SampleViewIndexBias(l9_17,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*(1000.0-(-1000.0)))/(0.99998999-0.0));
gParticle.Life=0.0+(((DecodeFloat32(renderTarget2SampleViewIndexBias(l9_17,renderTarget2GetStereoViewIndex(),0.0),true)-0.0)*(6.0-0.0))/(0.99998999-0.0));
gParticle.Age=0.0+(((DecodeFloat32(renderTarget3SampleViewIndexBias(l9_17,renderTarget3GetStereoViewIndex(),0.0),true)-0.0)*(6.0-0.0))/(0.99998999-0.0));
vec2 l9_18=l9_12+vec2(0.0009765625,0.0);
gParticle.Size=0.0+(((DecodeFloat32(renderTarget0SampleViewIndexBias(l9_18,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*(100.0-0.0))/(0.99998999-0.0));
gParticle.Color.x=0.0+(((DecodeFloat32(renderTarget1SampleViewIndexBias(l9_18,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*(1.00001-0.0))/(0.99998999-0.0));
gParticle.Color.y=0.0+(((DecodeFloat32(renderTarget2SampleViewIndexBias(l9_18,renderTarget2GetStereoViewIndex(),0.0),true)-0.0)*(1.00001-0.0))/(0.99998999-0.0));
gParticle.Color.z=0.0+(((DecodeFloat32(renderTarget3SampleViewIndexBias(l9_18,renderTarget3GetStereoViewIndex(),0.0),true)-0.0)*(1.00001-0.0))/(0.99998999-0.0));
vec2 l9_19=l9_12+vec2(0.0014648438,0.0);
vec4 l9_20=renderTarget2SampleViewIndexBias(l9_19,renderTarget2GetStereoViewIndex(),0.0);
vec4 l9_21=renderTarget3SampleViewIndexBias(l9_19,renderTarget3GetStereoViewIndex(),0.0);
gParticle.Color.w=0.0+(((DecodeFloat32(renderTarget0SampleViewIndexBias(l9_19,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*(1.00001-0.0))/(0.99998999-0.0));
gParticle.Mass=0.0+(((DecodeFloat32(renderTarget1SampleViewIndexBias(l9_19,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*(1000.0-0.0))/(0.99998999-0.0));
gParticle.Quaternion.x=(-1.0)+(((DecodeFloat16(vec2(l9_20.xy),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.y=(-1.0)+(((DecodeFloat16(vec2(l9_20.zw),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.z=(-1.0)+(((DecodeFloat16(vec2(l9_21.xy),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.w=(-1.0)+(((DecodeFloat16(vec2(l9_21.zw),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
...
bool l9_3=l9_2>=(1500*(vfxNumCopies+1));
bool l9_4;
if (!l9_3)
{
l9_4=vfxBatchEnable[sc_GetLocalInstanceID()/1500]==false;
}
else
{
l9_4=l9_3;
...
vec4 l9_10=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
vec4 l9_11;
...
float l9_13=l9_10.w;
vec4 l9_14=l9_10;
l9_14.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_13))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_13;
l9_12=l9_14;
}
else
{
...
#endif
vec2 l9_4=((((varPackedTex.xy-Port_Center_N012)*(vec2(Port_Input0_N011)/(clamp(Port_Import_N091,vec2(0.0),vec2(10.0))+vec2(1.234e-06))))+Port_Center_N012)*vec2(Port_Input1_N013))-vec2(Port_Input1_N014);
float l9_5=atan(l9_4.y*Port_Input1_N017,l9_4.x);
float l9_6=floor(mod(float(Interp_Particle_Index%1500),Port_Input1_N057));
float l9_7;
if (l9_6==0.0)
{
l9_7=Port_Value0_N055;
}
else
{
float l9_8;
...
if (l9_6==2.0)
{
l9_9=Port_Value2_N055;
}
else
{
l9_9=Port_Default_N055;
}
l9_8=l9_9;
}
l9_7=l9_8;
}
float l9_10=(Port_Input0_N023*3.1415927)/(clamp(floor(l9_7),Port_Input1_N027,Port_Input2_N027)+1.234e-06);
if ((float((((((1.0-(cos((floor((l9_5/(l9_10+1.234e-06))+Port_Input1_N030)*l9_10)-l9_5)*length(l9_4)))-Port_RangeMinA_N053)/(clamp(Port_Import_N003,0.0,1.0)-Port_RangeMinA_N053))*(Port_RangeMaxB_N053-Port_RangeMinB_N053))+Port_RangeMinB_N053)<Port_Input1_N054)*1.0)!=0.0)
{
discard;
}
vec4 l9_11;
...
{
l9_11=vec4(Interp_Particle_Color.w);
}
#else
{
vec4 l9_12;
...
#if (sc_FramebufferFetch)
{
vec4 l9_14=sc_readFragData0_Platform();
vec4 l9_15;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_16=l9_14;
l9_16.x=l9_14.x+_sc_framebufferFetchMarker;
l9_15=l9_16;
}
#else
{
...
#else
{
vec2 l9_17=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_18;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_19=vec3(l9_17,0.0);
l9_19.y=((2.0*l9_17.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_18=l9_19.xy;
}
#else
{
...
{
l9_21=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_18,sc_ScreenTextureLayout,l9_20),0.0);
}
#else
{
l9_21=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_18,sc_ScreenTextureLayout,l9_20).xy,0.0);
}
#endif
l9_13=l9_21;
}
...
{
vec4 l9_23=l9_13;
l9_23.x=l9_13.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_22=l9_23;
}
#else
{
...
#endif
vec3 l9_24=mix(l9_22.xyz,definedBlend(l9_22.xyz,Interp_Particle_Color.xyz).xyz,vec3(Interp_Particle_Color.w));
...
{
l9_26=vec4(mix(vec3(1.0),Interp_Particle_Color.xyz,vec3(Interp_Particle_Color.w)),Interp_Particle_Color.w);
}
#else
{
vec4 l9_27;
...
{
l9_28=clamp(Interp_Particle_Color.w,0.0,1.0);
}
#else
{
l9_28=Interp_Particle_Color.w;
}
#endif
l9_27=vec4(Interp_Particle_Color.xyz*l9_28,l9_28);
}
#else
{
l9_27=Interp_Particle_Color;
}
#endif
l9_26=l9_27;
}

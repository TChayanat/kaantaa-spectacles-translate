...
float l9_6=floor(mod(float(int(Interp_Particle_Index)%1500),Port_Input1_N057));
float l9_7;
if (l9_6==0.0)
{
...
#endif
l9_13=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_18,sc_ScreenTextureLayout,l9_20).xy,0.0);
}
#endif
vec4 l9_21;
...
{
vec4 l9_22=l9_13;
l9_22.x=l9_13.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_21=l9_22;
}
#else
{
...
#endif
vec3 l9_23=mix(l9_21.xyz,definedBlend(l9_21.xyz,Interp_Particle_Color.xyz).xyz,vec3(Interp_Particle_Color.w));
...
{
l9_25=vec4(mix(vec3(1.0),Interp_Particle_Color.xyz,vec3(Interp_Particle_Color.w)),Interp_Particle_Color.w);
}
#else
{
vec4 l9_26;
...
{
l9_27=clamp(Interp_Particle_Color.w,0.0,1.0);
}
#else
{
l9_27=Interp_Particle_Color.w;
}
#endif
l9_26=vec4(Interp_Particle_Color.xyz*l9_27,l9_27);
}
#else
{
l9_26=Interp_Particle_Color;
}
#endif
l9_25=l9_26;
}
...
{
l9_28=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_28=vec4(0.0);

...
uniform float Port_SpawnRate_N006;
uniform vec3 vfxLocalAabbMin;
uniform vec3 vfxLocalAabbMax;
uniform float Port_Import_N005;
uniform vec3 Port_Import_N017;
uniform vec3 Port_Import_N018;
...
uniform float Port_Value_N030;
uniform mat4 vfxModelMatrix[32];
uniform float Port_Input1_N012;
uniform float Port_Input1_N170;
uniform vec3 Port_Input1_N020;
uniform vec3 Port_Value0_N022;
uniform vec3 Port_Value1_N022;
uniform vec3 Port_Value2_N022;
uniform vec3 Port_Default_N022;
uniform float overrideTimeDelta;
uniform bool vfxEmitParticle[32];
uniform vec3 Port_Input1_N026;
...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/257];
}
else
{
l9_15=l9_14;
...
gParticle.Life=0.0+(((DecodeFloat32(renderTarget2SampleViewIndexBias(l9_16,renderTarget2GetStereoViewIndex(),0.0),true)-0.0)*(3600.0-0.0))/(0.99998999-0.0));
gParticle.Age=0.0+(((DecodeFloat32(renderTarget3SampleViewIndexBias(l9_16,renderTarget3GetStereoViewIndex(),0.0),true)-0.0)*(3600.0-0.0))/(0.99998999-0.0));
...
gParticle.Color.x=0.0+(((DecodeFloat8(l9_20.z,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
gParticle.Color.y=0.0+(((DecodeFloat8(l9_20.w,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
gParticle.Color.z=0.0+(((DecodeFloat8(l9_21.x,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
gParticle.Color.w=0.0+(((DecodeFloat8(l9_21.y,true)-0.0)*(1.00001-0.0))/(1.0-0.0));
...
vec3 N63_system_getParticleRandomVec3(bool useParticleID,bool useNodeID,bool useTime,float extraSeed)
{
return ssGetParticleRandom(3,useTime,useNodeID,useParticleID,63.0,gParticle,extraSeed,tempGlobals.gTimeElapsed).xyz;
}
...
int l9_1=(vfxOffsetInstancesRead+gParticle.StateID)*3;
int l9_2=l9_1/vfxTargetWidth;
vec2 l9_3=((vec2(ivec2(l9_1-(l9_2*vfxTargetWidth),l9_2))+vec2(0.5))/vec2(2048.0,vfxTargetSizeRead.y))+vec2(0.00048828125,0.0);
gParticle.SpawnIndex=(-1.0)+(((DecodeFloat32(renderTarget0SampleViewIndexBias(l9_3,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*(500000.0-(-1.0)))/(0.99998999-0.0));
gParticle.NextBurstTime=0.0+(((DecodeFloat16(renderTarget1SampleViewIndexBias(l9_3,renderTarget1GetStereoViewIndex(),0.0).xy,true)-0.0)*(300.0-0.0))/(0.99998999-0.0));
bool l9_4=overrideTimeEnabled==1;
float l9_5;
if (l9_4)
{
...
if (l9_4)
{
l9_6=overrideTimeDelta;
}
else
{
l9_6=max(sc_Time.y,0.0);
}
float l9_7=gParticle.TimeShift;
float l9_8=l9_7*l9_6;
float l9_9=l9_5-l9_8;
if (vfxEmitParticle[sc_GetLocalInstanceID()/257])
{
gParticle.SpawnAmount+=(Port_SpawnRate_N006*l9_6);
if (l9_5>=gParticle.NextBurstTime)
{
...
if (gParticle.SpawnIndex>=256.0)
{
gParticle.SpawnIndexRemainder=mod(gParticle.SpawnIndex,256.0);
}
}
...
if (!l9_11)
{
l9_12=gParticle.Age>=(gParticle.Life-l9_6);
}
else
{
l9_12=l9_11;
...
if (l9_20)
{
ssGlobals l9_21=ssGlobals(l9_5,l9_6,l9_9-0.0);
float l9_22=max(Port_Import_N058,0.0099999998);
ssCalculateParticleSeed(gParticle);
float l9_24=floor(16.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_24))/16.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_24)/16.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
tempGlobals=l9_21;
vec3 l9_25=N63_system_getParticleRandomVec3(true,true,true,0.0);
vec3 l9_26=N63_system_getParticleRandomVec3(true,true,true,150.0);
float l9_27=1.0-clamp(Port_Import_N043,0.0,1.0);
float l9_28;
if (l9_27<=0.0)
{
l9_28=0.0;
...
gParticle.Position=(((vec3(l9_32,l9_34,l9_36)*(l9_37/vec3(length(l9_37+vec3(9.9999997e-05)))))*Port_Import_N017)*Port_Import_N005)+Port_Import_N018;
tempGlobals=l9_21;
gParticle.Size=mix(Port_Import_N050*l9_22,Port_Import_N051*l9_22,ssGetParticleRandom(1,true,true,true,66.0,gParticle,20.0,tempGlobals.gTimeElapsed).x);
...
gParticle.Life=Port_Value_N030;
...
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceID()/257]*vec4(gParticle.Position,1.0)).xyz;
int l9_42=sc_GetLocalInstanceID()/257;
...
int l9_43=sc_GetLocalInstanceID()/257;
gParticle.Force=mat3(vfxModelMatrix[l9_43][0].xyz,vfxModelMatrix[l9_43][1].xyz,vfxModelMatrix[l9_43][2].xyz)*gParticle.Force;
gParticle.Size=max(length(vfxModelMatrix[sc_GetLocalInstanceID()/257][0].xyz),max(length(vfxModelMatrix[sc_GetLocalInstanceID()/257][1].xyz),length(vfxModelMatrix[sc_GetLocalInstanceID()/257][2].xyz)))*gParticle.Size;
int l9_44=sc_GetLocalInstanceID()/257;
gParticle.Matrix=mat3(vfxModelMatrix[l9_44][0].xyz,vfxModelMatrix[l9_44][1].xyz,vfxModelMatrix[l9_44][2].xyz)*gParticle.Matrix;
...
mat3 l9_45=gParticle.Matrix;
vec3 l9_46;
if ((float(1.0==Port_Input1_N170)*1.0)!=0.0)
{
l9_46=Port_Input1_N026;
}
else
{
vec3 l9_47;
if ((float(length(gParticle.Velocity)<Port_Input1_N012)*1.0)!=0.0)
{
l9_47=Port_Input1_N020;
}
else
{
vec3 l9_48=gParticle.Velocity;
float l9_49=dot(l9_48,l9_48);
float l9_50;
if (l9_49>0.0)
{
...
float l9_51=floor(1.0);
vec3 l9_52;
if (l9_51==0.0)
{
l9_52=Port_Value0_N022;
}
else
{
vec3 l9_53;
...
if (l9_51==2.0)
{
l9_54=Port_Value2_N022;
}
else
{
l9_54=Port_Default_N022;
}
l9_53=l9_54;
}
l9_52=l9_53;
}
vec3 l9_55=cross(l9_47,l9_52);
...
vec3 l9_58=normalize(l9_46);
float l9_59=radians(length(gParticle.Velocity)*Port_Import_N027);
...
gParticle.Matrix=l9_45*mat3(vec3((l9_64*l9_63)+l9_61,l9_66-l9_68,l9_70+l9_71),vec3(l9_66+l9_68,(l9_72*l9_65)+l9_61,l9_73-l9_74),vec3(l9_70-l9_71,l9_73+l9_74,(l9_69*l9_67)+l9_61));
vec3 l9_75=abs(gParticle.Velocity*vec3(gParticle.Mass))/(vec3(l9_6*Port_Multiplier_N272)+vec3(1.234e-06));
gParticle.Force+=clamp((((vec3(Port_Import_N126)*vec3(Port_Import_N127))*vec3(Port_Import_N128))*((-gParticle.Velocity)*vec3(length(gParticle.Velocity))))*vec3(Port_Input4_N137),-l9_75,l9_75);
gParticle.Quaternion=matrixToQuaternion(gParticle.Matrix);
float l9_76=clamp(l9_6,9.9999997e-05,0.5);
gParticle.Age+=l9_76;
...
{
l9_77=gParticle.Force.x;
}
gParticle.Force.x=l9_77;
float l9_78;
...
{
l9_78=gParticle.Force.y;
}
gParticle.Force.y=l9_78;
float l9_79;
...
{
l9_79=gParticle.Force.z;
}
gParticle.Force.z=l9_79;
gParticle.Mass=max(0.0049999999,gParticle.Mass);
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*l9_76);
float l9_80;
...
{
l9_80=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_80;
float l9_81;
...
{
l9_81=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_81;
float l9_82;
...
{
l9_82=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_82;
gParticle.Position+=(gParticle.Velocity*l9_76);
vec2 l9_83=vec2(3.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_84=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_85;
if (texture0.x<0.5)
{
l9_85=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_85,l9_86)+(vec2(float(l9_84%682),float(l9_84/682))*l9_83))*2.0)-vec2(1.0),1.0,1.0));
...
if (l9_4&&(overrideTimeDelta==0.0))
{
vec4 l9_87;
if (sc_GetLocalInstanceID()==0)
{
l9_87=vec4((texture0*2.0)-vec2(1.0),1.0,1.0);
}
else
{
l9_87=vec4(0.0);
}
sc_SetClipPosition(l9_87);
...
{
int l9_4=int(floor(Interp_Particle_Coord.x*3.0));
float l9_5;
float l9_6;
float l9_7;
float l9_8;
...
vec4 l9_43=ssEncodeFloat32(Interp_Particle_Life,0.0,3600.0,0.99998999);
vec4 l9_44=ssEncodeFloat32(Interp_Particle_Age,0.0,3600.0,0.99998999);
l9_40=l9_44.w;
l9_39=l9_44.z;
l9_38=l9_44.y;
l9_37=l9_44.x;
...
if (l9_4==2)
{
vec2 l9_59=ssEncodeFloat16(Interp_Particle_Size,0.0,100.0,0.99998999);
vec2 l9_60=ssEncodeFloat16(Interp_Particle_Quaternion.x,-1.0,1.0,0.99998999);
vec2 l9_61=ssEncodeFloat16(Interp_Particle_Quaternion.y,-1.0,1.0,0.99998999);
vec2 l9_62=ssEncodeFloat16(Interp_Particle_Quaternion.z,-1.0,1.0,0.99998999);
vec2 l9_63=ssEncodeFloat16(Interp_Particle_Quaternion.w,-1.0,1.0,0.99998999);
l9_58=0.0+(((clamp(Interp_Particle_Color.w,0.0,1.00001)-0.0)*(1.0-0.0))/(1.00001-0.0));
l9_57=0.0+(((clamp(Interp_Particle_Color.z,0.0,1.00001)-0.0)*(1.0-0.0))/(1.00001-0.0));
l9_56=0.0+(((clamp(Interp_Particle_Color.y,0.0,1.00001)-0.0)*(1.0-0.0))/(1.00001-0.0));
l9_55=0.0+(((clamp(Interp_Particle_Color.x,0.0,1.00001)-0.0)*(1.0-0.0))/(1.00001-0.0));
l9_54=l9_63.y;
l9_53=l9_63.x;
l9_52=l9_62.y;
l9_51=l9_62.x;
...
vec4 l9_64=vec4(l9_5,l9_6,l9_7,l9_8);
vec4 l9_65=vec4(l9_9,l9_10,l9_11,l9_12);
vec4 l9_66=vec4(l9_13,l9_14,l9_15,l9_16);
vec4 l9_67=vec4(l9_17,l9_18,l9_19,l9_20);
vec4 l9_68;
vec4 l9_69;
if (int(Interp_Particle_Index)==((257*(int(Interp_Particle_Index/257.0)+1))-1))
{
vec2 l9_70=ssEncodeFloat16(Interp_Particle_NextBurstTime,0.0,300.0,0.99998999);
l9_69=vec4(l9_70.x,l9_70.y,l9_65.z,l9_65.w);
l9_68=ssEncodeFloat32(Interp_Particle_SpawnIndex,-1.0,500000.0,0.99998999);
}
else
{
l9_69=l9_65;
...
vec4 l9_71;
if (dot(((l9_68+l9_69)+l9_66)+l9_67,vec4(0.23454))==0.34231836)
{
l9_71=l9_68+vec4(1e-06);
}
else
{
l9_71=l9_68;

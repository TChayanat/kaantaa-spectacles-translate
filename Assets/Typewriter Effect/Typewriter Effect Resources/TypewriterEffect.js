...
Set bool to tru, if you want to replace the last text and type a brand new text: 
...
//@input float delayBetweenChars  = 0.1
...
global.typeText = function(myText, replaceText){
    ...
    // if replaceText specifically set to true, it "deletes" the old text by setting it to an emopty string
    if(replaceText == true){
        targetText.text = "";
    }
